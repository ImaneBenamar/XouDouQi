...
public class Cat extends Animal {
	...
	private static final int CAT_POWER = 2;
	
	public final String PieceFormat = "C" + player.getColor();


	// Regular methods

	public Cat(Board board, Point position, Player player) {
		super(board, position, player);
	}

	public Cat() {
		System.out.println("New Empty Cat was created");
	}

	// Extended methods from super class Animal
	...
	public String toString() {
		return "Cat: Power" + this.getPower() + " " + this.player.toString();
	}
